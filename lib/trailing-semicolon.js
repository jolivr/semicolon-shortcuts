...
var TrailingSemicolon = self = {
  ...
  getConfig: function(config) {
    return atom.config.get('semicolon-shortcuts.' + config);
  },
  ...
  activate: function() {
    ...
    self.subscriptions.add(
      atom.commands.add('atom-workspace', {
        ...
        'trailing-semicolon:semicolon-eol': function() {
          self['semicolon-eol'].call(self);
        },
  ...
  'semicolon-newline': function() {
    self.applyTrailingCharacter(';', true, false);
  },
  'semicolon-eol': function() {
    self.applyTrailingCharacter(';', false, true);
  },
  ...
  applyTrailingCharacter: function(character, startNewline, moveEndOfLine) {
    console.log(`New Line: ${startNewline}, EoL: ${moveEndOfLine}`);
